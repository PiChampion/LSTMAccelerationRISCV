...
void dma::transfer()
{
  ...
  sc_core::sc_time start; 						// Transaction start
  ...
  cout << sc_core::sc_time_stamp() << " " << sc_object::name()
       << " transfer READ Completed in " << sc_core::sc_time_stamp() - start << endl;
  ...
  cout << sc_core::sc_time_stamp() << " " << sc_object::name()
       << " transfer WRITE Completed in " << sc_core::sc_time_stamp() - start << endl;
